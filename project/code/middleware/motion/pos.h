...
public:
    ...
    void connect_inputs(float* speed, float* angle_velocity)
    {
        input_encoder_count_ = speed;
    ...
    void update() override
    {
        ...
        float speed_pixel = pixel_to_count(*input_encoder_count_);

        // 2. 更新位置
        x_ += speed_pixel * cosf(yaw_) * DT;
        y_ += speed_pixel * sinf(yaw_) * DT;
